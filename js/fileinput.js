...
(function (factory) {
    ...
    tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '   {uploadIcon}\n</button>\n';
    tZoom = '<button type="button" id="preview-modal-btn" class="btn btn-default btn-xs btn-block" title="{zoomTitle}: {caption}">\n' +
        '   {zoomInd}\n' +
        '</button>\n';
    ...
    FileInput.prototype = {
        ...
        _previewFile: function (i, file, theFile, previewId, data) {
            ...
            if (chkTypes || chkMimes) {
                ...
                $('#preview-modal-btn').on('click', function(e) {
                    e.preventDefault();
                    $('#tcx-modal').modal('show');
                });
            } else {
    ...
    $.fn.fileinput.defaults = {
        ...
        uploadIcon: '<i class="fa fa-line-chart" aria-hidden="true"></i>',
